...
if [[ $vlc == y  && $bits != 32bit ]]; then
    ...
    if do_vcs "https://github.com/mozilla/fxc2.git"; then
        ...
        do_patch "https://gist.githubusercontent.com/1480c1/a460b9978a09e9a112ca0dd789abb437/raw/0004-Don-t-use-MAX_PATH-for-the-dllPath.patch" am
        do_patch "https://gist.githubusercontent.com/1480c1/a460b9978a09e9a112ca0dd789abb437/raw/0005-print-Combine-printf-commands.patch" am
        do_patch "https://gist.githubusercontent.com/1480c1/a460b9978a09e9a112ca0dd789abb437/raw/0006-temp.patch" am
        $CXX -static -static-libgcc -static-libstdc++ -o "$DXSDK_DIR/fxc2.exe" fxc2.cpp -ld3dcompiler $CFLAGS
        case $bits in
    ...
    if do_vcs "https://github.com/qt/qtbase.git#branch=${_qt_version:=5.15}"; then
        ...
        do_patch "https://gist.githubusercontent.com/1480c1/c49260c1c5061ca88ccc10827c10c23f/raw/0007-qmake-Patch-win32-g-for-static-builds.patch" am
...
EOF
    ...
    if do_vcs "https://code.videolan.org/videolan/vlc.git"; then
        ...
        config_path=".." do_configure \
            ...
            LIBS="$($PKG_CONFIG --libs libcddb regex iconv harfbuzz) -lwsock32 -lws2_32 -lpthread -liphlpapi"
        do_makeinstall
        do_checkIfExist
